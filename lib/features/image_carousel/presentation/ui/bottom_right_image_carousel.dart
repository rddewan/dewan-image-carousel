...
class BRImageCarousel extends StatefulWidget {
  final double? height;
  ...
  @override
  State<BRImageCarousel> createState() =>
      _BRImageCarouselState();
}

class _BRImageCarouselState extends State<BRImageCarousel> {
