...
class BCBLImageCarousel extends StatefulWidget {
  final double? width;
  final double? height;
  ...
  @override
  State<BCBLImageCarousel> createState() =>
      _BCBLImageCarouselState();
}
...
class _BCBLImageCarouselState extends State<BCBLImageCarousel> {  
  ...
  Widget build(BuildContext context) {
    ...
    return widget.images.isEmpty ? const SizedBox() : Stack( 
